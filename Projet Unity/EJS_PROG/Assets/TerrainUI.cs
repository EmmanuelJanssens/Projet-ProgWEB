...
public class TerrainUI : MonoBehaviour
{
    ...
    public void GenerateNoiseMap()
    {
        ...
        {
            NoiseGen.Generate();
            EditorNav.GONoiseMap.SetActive(true);
            EditorNav.GOTerrain.SetActive(false);
    ...
    public void GenerateTerrain()
    {
        if(AppManage.NoiseMapGenerated == true)
        {
            if (TerrainGen.HeightScale > 2)
            {
                ...
                EditorNav.GONoiseMap.SetActive(false);
                EditorNav.GOTerrain.SetActive(true);
            }
        }
    }
    /// <summary>
    ...
    public void UpdatePersistenceSliderValue(float value)
    {
        ...
        Debug.Log(NoiseGen.Persistence);
        if (AppManage.NoiseMapGenerated)
        {
